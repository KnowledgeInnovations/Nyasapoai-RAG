...
export default function HomePage() {
  return (
    <>
      {/* Hero */}
      <section className="relative overflow-hidden bg-gradient-to-b from-indigo-50 via-white to-white px-6 py-24 text-center">
        <div className="mx-auto max-w-3xl">
          ...
          <h1 className="mt-6 text-5xl font-extrabold leading-tight tracking-tight text-gray-900">
            Your documents.
            <br />
            <span className="text-indigo-600">Your answers.</span>
          </h1>
      ...
      <section className="px-6 py-24 text-center">
        <div className="mx-auto max-w-xl">
          ...
          <p className="mt-4 text-gray-500">
            Book a 30-minute demo and see NyansapoAI answer questions from your
            own documents — live.
          </p>
          <Link
            href="/demo"
            className="mt-8 inline-block rounded-xl bg-indigo-600 px-8 py-3 text-sm font-semibold text-white shadow-sm transition hover:bg-indigo-700"
          >
            Book a free demo
          </Link>
        </div>
