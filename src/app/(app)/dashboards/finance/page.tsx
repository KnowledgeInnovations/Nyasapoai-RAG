  ...
  return (
    <DashboardShell title="Finance Dashboard" description="Revenue, payments, cash flow, and financial risks extracted from your documents." lastUpdated={now}>
      ...
      <div className="grid gap-4 lg:grid-cols-3">
        <DashboardInsight
          label="Revenue and Collections"
          question="What revenue has been collected, what is pending, and what are the total receivables mentioned in the uploaded financial documents? Give specific figures, dates, and project names." />
        <DashboardInsight
          label="Outstanding Payments"
          question="What invoices, payments, or debts are outstanding? Who owes money, how much, and for how long? Are any accounts overdue according to the financial documents?" />
        <DashboardInsight
          label="Financial Risks and Cash Flow"
